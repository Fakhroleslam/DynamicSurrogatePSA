...
options = trainingOptions('adam', ...
    ...
    'LearnRateDropFactor',0.5, ...    %%0.1
    'LearnRateDropPeriod',100, ...
    'MiniBatchSize',50, ...
    'ValidationData',{test_inputs,test_targets}, ...
...
tic
net = trainNetwork(train_inputs,train_targets,layers,options);
toc
...
% Display MSE for both sets
fprintf('MSE for training set: %f\n', mse_train);
fprintf('MSE for test set: %f\n', mse_test);
...
legend('Pseudo-experimental data', 'GRU output (Training Set)','GRU Output (Test Set)','Location','southwest')
set(gca,'fontSize',18)
